...
const Footer: React.FC = () => {
  return (
    <footer className="relative py-24 bg-gradient-to-b from-dark-900 to-black overflow-hidden">
      {/* Background Effects */}
      <div className="absolute inset-0">
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-neon-blue/10 rounded-full blur-3xl animate-pulse" />
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-neon-magenta/10 rounded-full blur-3xl animate-pulse delay-1000" />
      </div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-300 mb-12 max-w-2xl mx-auto">
            Join thousands of businesses already transforming their expense management with ExpenseIQ's AI-powered platform.
          </p>
        ...
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          <div>
            <h3 className="text-xl font-bold mb-4 text-neon-blue">Product</h3>
          ...
          <div>
            <h3 className="text-xl font-bold mb-4 text-neon-magenta">Company</h3>
            <ul className="space-y-2 text-gray-400">
              <li><a href="#" className="hover:text-neon-magenta transition-colors">About</a></li>
              <li><a href="#" className="hover:text-neon-magenta transition-colors">Blog</a></li>
              <li><a href="#" className="hover:text-neon-magenta transition-colors">Careers</a></li>
              <li><a href="#" className="hover:text-neon-magenta transition-colors">Press</a></li>
            </ul>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li><a href="#" className="hover:text-yellow-400 transition-colors">GDPR</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="flex items-center gap-4 mb-4 md:mb-0">
            <div className="w-8 h-8 bg-gradient-to-r from-neon-blue to-neon-magenta rounded-lg flex items-center justify-center">
              <span className="text-white font-bold text-sm">EQ</span>
            </div>
            <span className="text-gray-400">© 2024 ExpenseIQ. All rights reserved.</span>
          </div>
